...
import useCReateManeger from '../services/useCreateManeger';
...
export default function ManegerCreatePage() {
    const [menuIsOpened, setMenuIsOpened] = useState(false);
    const { time, timeSession } = useSessionTimeout();
    console.log(time, timeSession);
    const { handleChangeValue, formData, handleSubmit, loaderControl } = useCReateManeger()
    useEffect(() => {
        const data = async () => {
                        ...
                        <div className="h-full  flex flex-col  w-full  ">
                            ...
                            <div className='h-full  flex flex-col w-full  justify-center '>
                                ...
                                <div className='w-ful flex justify-center items-center '>
                                    <div className=' w-11/12  bg-white  flex flex-col justify-center md:w-1/2 md:mt-10'>
                                        <TopElementForAllForm
                                            title='Criar Novo usúario'
                                        />
                                        <form className='bg-white p-8   w-full flex flex-col  justify-center  items-center' onSubmit={handleSubmit}>
                                            ...
                                            <div className='w-10/12 mt-3'>
                                                ...
                                                >
                                                    ...
                                                    <option value={typeOfUser.TALLER}>caixa</option>
                                                    <option  value={typeOfUser.ADMIN}>Administrador</option>
                                                    <option  value={typeOfUser.CREDIT_ANALIST}>Analista de Crédito</option>
                                                    <option  value={typeOfUser.FINANCIAL_MANEGER}>Gestor Financeiro</option>
                                                </select>
                                            </div>
